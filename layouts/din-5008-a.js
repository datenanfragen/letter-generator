const mm2pt = require('../utility').mm2pt;
 ...
 * @param {Object|Array|string} information_block
 ...
 * @returns {Object}
 */
function layout(sender_address, recipient_address, information_block, subject, content, signature) {
    return {
        pageSize: 'A4',
